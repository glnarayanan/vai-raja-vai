...
export const scene1_TheReturn = [
...

  {
    ...
    responses: [
      ...
      },
      {
        ...
        suspicionChange: { wife_mythili: 5 },
        nextDialogueId: "return_003",
        note: "Aligns with what Ammini heard from Ayyappan but raises question about why MG Road is near a temple."
      },
      {
        id: "return_002_c",
...

  {
    ...
    speaker: "wife_mythili",
    speakerName: "Mythili",
    text: "So, Ram, I was just talking to Ammini. She says Ayyappan mentioned you all had a 'memorable birthday dinner.' Tell me about this dinner.",
    context: "Ugadi party, living room. Mythili corners Ram near the snack table. Ammini is within earshot. Friends are scattered across the house -- check sync status.",
    responses: [
      {
        id: "party_001_a",
        ...
        factCreated: {
          ...
          witnesses: ["wife_mythili", "wife_ammini"],
          timestamp: "bangalore_evening_1",
          location: "party_living_room"
        },
        suspicionChange: { wife_mythili: 2, wife_ammini: 1 },
      ...
      },
      {
        ...
        suspicionChange: { wife_mythili: 5, wife_ammini: 3 },
        nextDialogueId: "party_002",
        friendBlurtRisk: true,
      ...
      },
      {
        ...
        type: "DEFLECT",
        factCreated: null,
        suspicionChange: { wife_mythili: 4, wife_ammini: 0 },
        nextDialogueId: "party_002"
      }
    ]
  },

  {
    ...
    context: "Ammini approaches casually but her eyes are sharp. She's been comparing notes with Mythili.",
    responses: [
      {
        id: "party_002_a",
        ...
        factCreated: {
          ...
          witnesses: ["wife_ammini", "wife_mythili"],
          timestamp: "bangalore_day_2",
          location: "party_living_room"
        },
        suspicionChange: { wife_ammini: 2, wife_mythili: 1 },
      ...
      },
      {
        ...
        type: "DEFLECT",
        factCreated: null,
        suspicionChange: { wife_ammini: 5, wife_mythili: 2 },
        nextDialogueId: "party_003"
      },
      {
        id: "party_002_c",
        text: "We went trekking near the temple. Rough terrain. We're not exactly athletes, Ammini.",
        type: "RISKY",
        factCreated: {
          subject: "Bangalore Trip",
        ...
        suspicionChange: { wife_ammini: 3, wife_mythili: 3 },
        nextDialogueId: "party_003",
  ...
  {
    id: "party_003",
    speaker: "wife_chamundi",
    speakerName: "Chamundi",
    ...
    context: "Chamundi (Hegde's wife) approaches cheerfully. She's not suspicious yet -- just curious. But 'cultural show' is Hegde's euphemism for anything.",
    responses: [
      {
        id: "party_003_a",
      ...
      },
      {
        ...
        suspicionChange: { wife_chamundi: 3 },
        nextDialogueId: "party_004",
        friendBlurtRisk: true,
      ...
      },
      {
        ...
        suspicionChange: { wife_chamundi: 2 },
        nextDialogueId: "party_004"
      }
    ]
  },
...

  {
    ...
    context: "Janaki (Vedham's wife) is genuinely concerned, not suspicious. But her question is dangerous -- Vedham IS nervous because something DID happen.",
    responses: [
      {
        id: "party_005_a",
        ...
        factCreated: {
          ...
          witnesses: ["wife_janaki"],
          timestamp: "party",
          location: "party_dining_room"
        },
        suspicionChange: { wife_janaki: 1 },
      ...
      },
      {
        ...
        suspicionChange: { wife_janaki: 2 },
        nextDialogueId: "party_006",
        note: "Verifiable lie -- Janaki will ask Vedham, who will panic."
      },
      {
        id: "party_005_c",
        text: "Vedham? Strange? That's just regular Vedham! He's always jumpy. You should know that better than anyone, Janaki!",
        type: "DEFLECT",
        factCreated: null,
        suspicionChange: { wife_janaki: 3 },
        nextDialogueId: "party_006"
      }
    ]
  },

  {
    ...
    responses: [
      ...
      },
      {
        ...
        nextDialogueId: "party_007",
        friendBlurtRisk: true,
        note: "Deflects to Reddy. If Mrs. Reddy hears this, she'll investigate."
      },
      {
        id: "party_006_d",
  ...
  {
    id: "party_007",
    speaker: "wife_mrs_reddy",
    speakerName: "Mrs. Reddy",
    ...
    context: "Mrs. Reddy (Reddy's wife) is innocent but dangerously close to the truth. The irony is thick. This is a minefield.",
    responses: [
      {
        id: "party_007_a",
        ...
        factCreated: {
          ...
          witnesses: ["wife_mrs_reddy"],
          timestamp: "party",
          location: "party_kitchen"
        },
        suspicionChange: { wife_mrs_reddy: 1 },
      ...
      },
      {
        ...
        suspicionChange: { wife_mrs_reddy: 3 },
        nextDialogueId: "party_008",
        note: "If anyone else mentions 'Maggi' as a person later, this collapses."
      },
      {
        id: "party_007_c",
        text: "Mrs. Reddy, you're analyzing your husband's dreams now? Let the man sleep in peace!",
        type: "DEFLECT",
        factCreated: null,
        suspicionChange: { wife_mrs_reddy: 2 },
        nextDialogueId: "party_008"
      }
    ]
  },
  ...
  // NPCs: Maggi, Mythili, Ammini, friends in background
  // ═══════════════════════════════════════════════════════════════
    ...
    responses: [
      {
        ...
        factCreated: {
          ...
          witnesses: ["wife_mythili", "wife_ammini", "npc_maggi"],
      ...
      },
      {
        ...
        suspicionChange: { wife_mythili: 8, wife_ammini: 10 },
        nextDialogueId: "confront_002",
        friendBlurtRisk: true,
        note: "Drags Ayyappan into it. Ammini will immediately question Ayyappan about his 'cousin.' Collision risk: extreme."
      },
      {
        id: "confront_001_c",
        ...
        suspicionChange: { wife_mythili: 6, wife_ammini: 4 },
        nextDialogueId: "confront_002",
...

  {
    ...
    responses: [
      ...
      {
        id: "confront_003_d",
        text: "Mythili, Ammini -- this woman is trying to scam us. She's a con artist. Ayyappan, call the building security!",
        type: "DEFLECT",
        factCreated: {
          subject: "Maggi",
...

  {
    ...
    context: "Ammini has independently verified and found a contradiction. Scene 3 is closing. The web of lies is at breaking point. Transition to Scene 4 depends on the state.",
    responses: [
      {
        id: "confront_005_a",
        ...
        suspicionChange: { wife_ammini: 8, wife_mythili: 5 },
        nextDialogueId: null,
        note: "Scene 3 end. Transition to Scene 4. The lie is barely holding."
      },
      {
        id: "confront_005_b",
        text: "Ammini, Ayyappan is panicking because he owes this woman money for the travel booking. It's embarrassing, that's all. He didn't want you to know he overspent.",
        type: "SAFE",
        factCreated: {
          subject: "Maggi",
        ...
        suspicionChange: { wife_ammini: 4, wife_mythili: 3 },
        nextDialogueId: null,
        note: "Redirects suspicion to money issues, not moral issues. Ammini is more likely to buy this."
      },
      {
        id: "confront_005_c",
        ...
        type: "DEFLECT",
        factCreated: null,
        suspicionChange: { wife_ammini: 6, wife_mythili: 6 },
        nextDialogueId: null,
