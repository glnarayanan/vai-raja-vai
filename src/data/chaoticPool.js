...
export const chaoticPool = {
  ...
  // ─────────────────────────────────────────────
  // MAGGI - Anything about the mysterious woman
  // ─────────────────────────────────────────────
  maggi: {
    OVER_EXPLAINER: [
      "Maggi? Maragathavalli? She's approximately 5 foot 4, dark hair, was wearing a red saree that evening -- the one with the gold border, not the plain one. She arrived at 8:47 PM.",
      "She's nobody! Just a woman who happened to be in our hotel lobby at 11 PM wearing perfume that smelled like jasmine. I noticed because the hotel air freshener was sandalwood, so the contrast was--",
      "I saw her talk to Ram for exactly 4 minutes and 32 seconds. Not that I was timing. My watch was in my line of sight. Coincidence."
    ],
    NERVOUS: [
      "WHAT Maggi? There is NO Maggi! She doesn't exist! She was NEVER THERE! I need water. LOTS of water.",
      "I don't know any Maggi! Or Maragathavalli! Both names are new to me! I've never heard either name before in my LIFE!",
      "Who? WHAT? WHERE? I'm going to sit down now. My legs are shaking for completely unrelated reasons."
    ],
    AGREEABLE: [
      "Maggi? Yes, I know her! Wait, am I supposed to know her? Okay, I don't know her! Whatever Ram said!",
      "She's Ram's friend! No, she's a stranger! She's both! She's a friendly stranger! I agree with all versions!",
      "Yes, Maggi was there! No, Maggi wasn't there! Both statements are equally true in my experience!"
    ],
    LOOSE_CANNON: [
      "Maggi? The dead girl? I mean, the NOT dead girl? The one who was lying on the floor NOT dead? Which Maggi?",
      "Oh, Maggi! Beautiful woman. Terrible situation. Those diamonds really complicated things. Wait, I didn't say diamonds.",
      "Maggi is the reason we all need lawyers. I mean, Maggi is a noodle brand. I love noodles. Please stop asking."
    ]
  },

  // ─────────────────────────────────────────────
  // NIGHT - What happened at night
  // ─────────────────────────────────────────────
  night: {
    OVER_EXPLAINER: [
      "We were in bed by 9 PM. Wait, no. I brushed my teeth at 9:07 PM, used the bathroom at 9:12 PM, and was in bed by 9:23 PM. The mattress was 6 inches thick. Queen size.",
      "Nothing happened at night! We sat in the room. Hegde snores. Volume approximately 45 decibels. I measured with an app.",
      "After dinner, which ended at 8:43 PM, we walked back — 247 steps, I counted — and then watched news until exactly 10 PM."
    ],
    NERVOUS: [
      "We slept! We ONLY slept! Why would you think we did anything else at night? Nights are for sleeping! That's all! SLEEP!",
      "Nothing! Nothing happened after dark! It was very dark! You can't see anything in the dark! Convenient, right? I mean, NORMAL!",
      "I was in my room ALL night! Doors locked! Windows closed! I saw NOTHING and HEARD nothing! Especially not at 2 AM!"
    ],
    AGREEABLE: [
      "Early to bed! Also late night adventures! Both happened! On the same night! Time is flexible!",
      "Yes, we were asleep by 9! Also yes, we were out until 3 AM! Sleep is a spectrum!",
      "Whatever time you think we went to bed — yes! That's exactly when! You're so perceptive!"
    ],
    LOOSE_CANNON: [
      "Night? Oh, you mean the night with the body? I mean, the night at the temple. The night temple. It's a thing.",
      "After midnight, everything gets blurry. The screaming, the running, the disposal — I mean, the prayers. Evening prayers.",
      "Best night of my life. Also worst night of my life. Those two categories overlapped significantly."
    ]
  }
};
