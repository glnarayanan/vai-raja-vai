...
const PARTY_DIALOGUES = [
  {
    ...
    responses: [
      ...
      {
        id: 'p1_deflect',
        text: "Forget Bangalore — this party is amazing, Priya! The decorations are beautiful.",
        type: 'deflect',
        fact: null,
        suspicionChange: 0,
        wifeId: 'wife_mythili',
  ...
  },
  {
    ...
    responses: [
      ...
      {
        id: 'p2_deflect',
        text: "Alice! Have you tried the biryani? Reddy's wife makes the best biryani in the city!",
        type: 'deflect',
        fact: null,
        suspicionChange: 1,
        wifeId: 'wife_alice',
  ...
  },
  {
    ...
    responses: [
      ...
      {
        id: 'p3_deflect',
        text: "Priya, I think Reddy just talks a lot in his sleep. My mother used to do the same!",
        type: 'deflect',
        fact: null,
        suspicionChange: 1,
        wifeId: 'wife_priya',
  ...
  },
  {
    ...
    responses: [
      ...
      {
        id: 'p4_deflect',
        text: "Deepa, you know how Vedham worries. He probably just called to say goodnight. Such a sweet husband!",
        type: 'deflect',
        fact: null,
        suspicionChange: 0,
        wifeId: 'wife_deepa',
  ...
  },
  {
    ...
    responses: [
      ...
      {
        id: 'p5_deflect',
        text: "Lakshmi, are you going through Vedham's pockets? That's not very trusting of you!",
        type: 'deflect',
        fact: null,
        suspicionChange: 2,
        wifeId: 'wife_lakshmi',
