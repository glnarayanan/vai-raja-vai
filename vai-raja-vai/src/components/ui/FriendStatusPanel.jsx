...
function getSyncStatusLabel(isSynced) {
  return isSynced
    ? { text: 'Synced', colorClass: 'text-kollywood-teal' }
    : { text: 'Un-synced', colorClass: 'text-orange-400' };
}
          ...
          return (
            <div key={friend.name} className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className={`text-[10px] font-medium ${syncStatus.colorClass}`}>
                  {syncStatus.text}
                </span>
              </div>
